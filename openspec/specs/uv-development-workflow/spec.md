# uv-development-workflow Specification

## Purpose
Define the reproducible uv workflow for installing, testing, and updating
Training Sync while preserving Python compatibility and isolating local and
