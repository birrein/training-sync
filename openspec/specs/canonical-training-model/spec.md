...
Define the provider-neutral canonical model for completed training activities, strength imports, exercise identity, provenance, effort observations, and remote replicas.
