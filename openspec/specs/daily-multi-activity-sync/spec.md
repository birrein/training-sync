# daily-multi-activity-sync Specification

## Purpose
Define safe, deterministic reconciliation of every Garmin activity for one date into an existing Obsidian daily training section, including preflight validation, replacement confirmation, and retained-daily partial-failure behavior.
